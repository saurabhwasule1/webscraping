...
# try:
url = "https://www.magicbricks.com/property-for-rent/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Service-Apartment,Residential-House,Villa&Locality=Panathur&cityName=Bangalore/Page-"
new_url = str(url) + str(1)
...
for num in (1,math.trunc(float(page_count.text)+ 1)):
    #url="https://www.magicbricks.com/property-for-rent/residential-real-estate?proptype=Multistorey-Apartment,Builder-Floor-Apartment,Penthouse,Studio-Apartment,Service-Apartment,Residential-House,Villa&Locality=Kadubeesanahalli,Whitefield,Marathahalli,Marathahalli-Sarjapur-Outer-Ring-Road&cityName=Bangalore/Page-"
    #new_url=str(url)+str(num)
    page = requests.get(new_url)
    print (page.status_code)
    time.sleep(40)
...
# try:
    ...
    #print(MB_renta_info.columns)
    #print(MB_renta_info.values)
